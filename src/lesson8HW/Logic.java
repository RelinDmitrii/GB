...
public class Logic {
    ...
    static char[][] map;
    static boolean finishedGame; // поле для завершения игры

    static Random random = new Random();

    public static void go() {
        finishedGame = true; // при сробатывании return остается значение
        printMap();
        ...
        finishedGame = false; //если доходим до конца переключаем флаг
    }
